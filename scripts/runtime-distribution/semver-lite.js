...
// The promotion workflow runs from a read-only checkout and deliberately does
// not install the application's production dependencies. Keep the tiny subset
// of SemVer needed by the distribution contract self-contained here.
...
module.exports = { valid, compare, rcompare };
